...
import feedbackBg from "../../assets/img/istockphoto-1152675766-612x612.jpg";
        ...
        return (
            <span style={{ color: "#f5c518", cursor: onClick ? 'pointer' : 'default', fontSize: '1.2rem' }}>
                {Array.from({ length: 5 }, (_, i) => (
                    <span key={i} onClick={onClick ? () => onClick(i + 1) : undefined}>
                        {i < score ? '★' : '☆'}
                    </span>
                ))}
            </span>
        ...
        >
            <div className="container py-4">
                <h2 className="text-center mb-4 fw-bold text-dark">
                    <i className="bi bi-chat-dots me-2"></i>Phản Hồi Của Bệnh Nhân
                </h2>
