            ...
            <div className="container pt-5">
                <div className="row g-5 pt-4">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <p className="mb-2"><i className="bi bi-geo-alt text-primary me-2"></i>123 Street, New York, USA
                        </p>
                        <p className="mb-2"><i className="bi bi-envelope-open text-primary me-2"></i>info@example.com
                        </p>
